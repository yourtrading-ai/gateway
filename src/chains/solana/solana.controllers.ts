...
export class SolanaController {
  static async balances(
    ...
    console.log(
      '🪧 -> SolanaController -> filteredBalances:',
      filteredBalances,
    );
    // console.log(
  ...
  static async allowances(_solanaish: Solanaish, req: AllowancesRequest) {
    // Not applicable.
  ...
  static async approve(_solanaish: Solanaish, _req: ApproveRequest) {
    // Not applicable.
    return {
  ...
  static async cancel(_solanaish: Solanaish, _req: CancelRequest) {
    // Not applicable.
    return {
